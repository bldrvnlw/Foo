conan install . Foo/0.2.0@ -s build_type=Release -s compiler.runtime=MD -o shared=False
conan install . Foo/0.2.0@ -s build_type=Debug -s compiler.runtime=MDd -o shared=False
